...
class _AddEmployeeScreenState extends State<AddEmployeeScreen> {
  ...
  void _onSubmit() {
    ...
    }else if(widget.employee == null && password.length < 8 ){
      showCustomSnackBarHelper('enter_8_digit_password'.tr);

    }else if(widget.employee == null && confirmPassword.length < 8){
      showCustomSnackBarHelper('confirm_8_digit_password'.tr);

    }else if(widget.employee == null && confirmPassword != password){
